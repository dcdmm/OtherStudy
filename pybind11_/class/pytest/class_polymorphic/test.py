import class_polymorphic
import class_polymorphic_py

c = class_polymorphic.Dog("Molly")
print(c.name)
print(c.bark())

c1 = class_polymorphic.pet_store()
...
c2 = class_polymorphic.pet_store2()
...
c_py = class_polymorphic_py.Dog("Molly_py")
print(c_py.name)
print(c_py.bark())
...
print(class_polymorphic_py.pet_store(c_py))
